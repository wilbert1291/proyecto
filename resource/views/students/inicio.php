...
<body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="<?php echo constant('URL');?>students/inicio">EduTec</a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo constant('URL');?>students/inicio">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo constant('URL');?>students/cursos">
                    ...
                    <div class="col-md-3">
                        <div class="card mb-4 shadow-sm">
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail">
                                <rect width="100%" height="100%" fill="#17a2b8"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em">0</text>
                            </svg>
                            <div class="card-body">
                                <center><p class="card-text">Calificación actual.</p></center>
                            </div>
                        </div>
                    </div>
                </div>
