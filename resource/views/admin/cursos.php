...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo constant('URL');?>admin/cursos">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                ...
                <?php include_once 'resource/views/admin/modal/cursosModal.php'; ?>
            </main>
        </div>
    </div>
    ...
    <script src="<?php echo constant('URL');?>public/js/admin/cursos.js"></script>
