    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="title_modal">Usuarios</h5>
                        ...
                        <div class="form-group">
                            ...
                            <select id="tipo_usuario" class="form-control">
                                ...
                                <?php
                                    ...
                                    foreach($this->tipo_usuario as $row){
                                        $tu = new tipo_usuarios_adapter();
                                        $tu = $row;
                                    ?>
                                <option value="<?php echo $tu->clave_tipo_usuario;?>"><?php echo $tu->nombre_tipo_usuario;?></option>
                                <?php  
                            ...
                            <select id="institucion" class="form-control">
                                ...
                                <?php
                                    ...
                                    foreach($this->instituciones as $row){
                                        $ins = new instituciones_adapter();
                                        $ins = $row;
                                ?>
                                <option value="<?php echo $ins->clave_institucion;?>"><?php echo $ins->nombre_institucion; ?></option>
                                <?php  
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select id="profesor" class="form-control">
                                    ...
                                    foreach($this->profesores as $row){
                                        $pro = new usuarios_adapter();
                                        $pro = $row;
                                    ?>
                                    <option value="<?php echo $pro->clave_usuario;?>"><?php echo $pro->nombre . " " . $pro->apellido_paterno . " " . $pro->apellido_materno; ?></option>
                                    <?php  
