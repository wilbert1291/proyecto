            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo constant('URL');?>admin/inicio">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo constant('URL');?>admin/instituciones">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="card mb-4 shadow-sm">
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail">
                                <rect width="100%" height="100%" fill="#17a2b8"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em"><?php echo $this->instituciones; ?></text>
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="card mb-4 shadow-sm">
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail">
                                <rect width="100%" height="100%" fill="#007bff"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em"><?php echo $this->usuarios; ?></text>
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="card mb-4 shadow-sm">
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail">
                                <rect width="100%" height="100%" fill="#28a745"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em">$<?php echo $this->ganancias; ?></text>
                            </svg>
                            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="card mb-4 shadow-sm">
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail">
                                <rect width="100%" height="100%" fill="#dc3545"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em"><?php echo $this->suscripciones; ?></text>
                            </svg>
                            <div class="card-body">
