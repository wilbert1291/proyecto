...
<body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="<?php echo constant('URL');?>teachers/inicio">EduTec</a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo constant('URL');?>teachers/inicio">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo constant('URL');?>teachers/alumnos">
