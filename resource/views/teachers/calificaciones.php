...
<body>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo constant('URL');?>teachers/calificaciones">
    ...
    <script src="<?php echo constant('URL');?>public/js/teachers/calificaciones.js"></script>
