...
<head>
    ...
    <title>Instituciones: Suscripción</title>
...
<body>
        ...
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo constant('URL'); ?>institutes/suscripcion">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                    <h1 class="h2">Suscripcion - Historial de suscripciones</h1>
                ...
                <?php include_once 'resource/views/institutes/modal/suscripcionesModal.php'; ?>
            </main>
        </div>
    </div>
    ...
    <script src="<?php echo constant('URL');?>public/js/institutes/suscripcion.js"></script>
