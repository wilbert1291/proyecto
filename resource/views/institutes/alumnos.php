...
<head>
    ...
    <title>Instituciones: Alumnos</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo constant('URL'); ?>institutes/alumnos">
            ...
            <?php include_once 'resource/views/institutes/modal/alumnosModal.php'; ?>
        </div>
    </div>
    ...
    <script src="<?php echo constant('URL');?>public/js/institutes/alumnos.js"></script>
