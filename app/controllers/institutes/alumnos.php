<?php
    ...
    class alumnos extends Controller{
        ...
        function index(){
            ...
            //Carga la vista
            $this->view->render('institutes/alumnos');
        }
        ...
        function insertar(){
            ...
            $this->model->guardar(["id_estado"=>$id_estado, "id_municipio"=>$id_municipio, "id_localidad"=>$id_localidad, "id_sexo"=>$id_sexo, "nombre"=>$nombre, "AP"=>$AP, "AM"=>$AM, "correo"=>$correo, "telefono"=>$telefono, "curp"=>$curp, "calle"=>$calle, "colonia"=>$colonia, "codigo_postal"=>$codigo_postal, "user"=>$user, "pass"=>$pass, "pregunta"=>$pregunta, "respuesta"=>$respuesta, 'profesor'=>$profesor, 'semestre'=>$semestre, 'grupo'=>$grupo, 'activo'=>$activo]);
        }
        ...
        function modificar(){
            ...
            $this->model->guardar(["id"=>$id, "id_estado"=>$id_estado, "id_municipio"=>$id_municipio, "id_localidad"=>$id_localidad, "id_sexo"=>$id_sexo, "nombre"=>$nombre, "AP"=>$AP, "AM"=>$AM, "correo"=>$correo, "telefono"=>$telefono, "curp"=>$curp, "calle"=>$calle, "colonia"=>$colonia, "codigo_postal"=>$codigo_postal, "pregunta"=>$pregunta, "respuesta"=>$respuesta, 'profesor'=>$profesor, 'semestre'=>$semestre, 'grupo'=>$grupo, 'activo'=>$activo]);           
        }
